...
- **Source control history**: {file paths}, {number of commits reviewed}, PRs #{numbers}, and code comments searched. Or "Not searched. No checkout or source-control connector was available; PR discussion is an explicit evidence gap."

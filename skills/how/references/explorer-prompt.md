...
Start by finding the relevant code. Discover relevant directories and files, search for key symbols, and read the actual implementation. Don't guess from names. Read the code.

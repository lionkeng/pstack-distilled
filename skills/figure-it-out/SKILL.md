---
name: "figure-it-out"
description: "Use only when explicitly requested or when another pstack skill directs you to it. Design an auditable playbook when no narrower one fits: a large migration, an ambitious multi-part change, or work a human reviews after stepping away. Scales rigor to the task, runs a hypothesis loop, and logs decisions via show-me-your-work. Use for figure-it-out, 'figure it out', a large migration, or when no narrower playbook applies."
license: MIT
metadata:
  pstack-distilled-origin: "cursor/plugins/pstack/skills/figure-it-out"
...
Open a plan or checklist whose first item is to read the Principles section of the **poteto-mode** skill. Then add the phases below as todos.
...
Then put the design into motion. Add its steps to the plan or checklist as concrete items, after the Phase C entry and before Phase D. Run each under the Phase C loop discipline, and weave the Phase D log through them, a row as each step lands, rather than saving the whole trail for the end.
